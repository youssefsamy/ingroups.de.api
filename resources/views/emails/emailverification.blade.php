...
<h3 style='font-family: Open Sans, Helvetica;'>Vielen Dank für Ihre Registrierung bei InGroups.</h3>
...
<div id='Data' style='font-family: Open Sans, Helvetica;max-width: 600px;vertical-align: top;'>
    ...
    <p>
    <br>
        Bitte klicken Sie auf diesen Link oder fügen Sie die Adresse in Ihren Browser ein, um Ihre Email-Adresse zu bestätigen.
        <br>
        <a href="{{$confirm_link}}">Email-Adresse bestätigen</a>
