...
<h3 style='font-family: Open Sans, Helvetica;'>Deine Kontaktanfrage: </h3>
<img alt='' id='eventImg' src='{{$contact_info['Bild']}}' style='font-family: Open Sans, Helvetica;width: 100%;height: auto;margin-bottom: 14px;max-width: 600px;'>
...
<div id='Data' style='font-family: Open Sans, Helvetica;max-width: 600px;vertical-align: top;'>
    <div id='ContactBox' style='font-family: Open Sans, Helvetica;padding-bottom: 4px;border: 1px solid #428BCA;border-radius: 4px;box-shadow: 0px 1px 1px rgba(0, 0, 0, 0.05);'>
        <div id='ContactHead' style='font-family: Open Sans, Helvetica;padding: 10px 20px;background-color: #428BCA;border-bottom: 1px solid #428BCA;border-top-right-radius: 3px;border-top-left-radius: 3px;'>
            <h3 style='font-family: Open Sans, Helvetica;color: #FFF;margin: 0px;'>Kontaktdaten</h3>
        </div>
        <div id='ContactBody' style='font-family: Open Sans, Helvetica;margin: 0px 20px;'>
            <div style='font-family: Open Sans, Helvetica;display: inline-block;'>
                ...
                <p style='font-family: Open Sans, Helvetica;'>({{$user_info['email']}})</p>
            </div>
        </div>
    </div>
    <div id='MessageBox' style='font-family: Open Sans, Helvetica;margin-top: 20px;padding: 4px 20px;background: none repeat scroll 0% 0% #434A54;border-radius: 4px;margin-bottom: 60px;'>
        <h3 style='font-family: Open Sans, Helvetica;color: #AAB2BD;'>Nachricht:</h3>

        <p style='font-family: Open Sans, Helvetica;color: #FFF;'>{{$contact_info['Nachricht']}}</p>
    </div>
