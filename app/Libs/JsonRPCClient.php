...
class JsonRPCClient
{
    ...
    public function __call($pMethod, $pParams)
    {
        ...
        $this->debug('Respond: ' . $responseMessage . "\r\n", true);
        ...
        $this->validate($responseDecoded['id'] != $requestId, 'Request id: ' . $requestId . ' is different from Respond id: ' . $responseDecoded['id']);
    ...
    protected function & getResponse(&$pRequest)
    {
        ...
        {
            throw new \RuntimeException('Respond Http Error - ' . $this->httpErrors[$httpCode]);
        }
